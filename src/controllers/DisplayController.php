                ...
                if (($k === $data->id) && (!($withOid && $conf['show_oids']))) {
                    ...
                    if (($v !== null) && isset($fkey_information['byfield'][$k])) {
                        ...
                        echo $misc->printVal($v, $finfo->type,
                            ['null' => true, 'clip' => $_REQUEST['strings'] == 'collapsed', 'class' => 'fk_value']);
                    } else {
            ...
            if ($confirm) {
                ...
                if ($rs->recordCount() == 1 && $attrs->recordCount() > 0) {
                    ...
                    while (!$attrs->EOF) {
                        ...
                        echo $data->printField("values[{$attrs->fields['attname']}]", $rs->fields[$attrs->fields['attname']], $attrs->fields['type'],
                            $extras);
