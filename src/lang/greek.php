...
// Error handling
    $lang['strnoframes']                      =
        'Το phpPgAdmin λειτουργεί καλύτερα με προγράμματα πλοήγησης που υποστηρίζουν πλαίσια (frames). Εαν επιθυμείτε να συνεχίσετε ακολουθήστε την παρακάτω σύνδεση.';
    ...
    $lang['strpostgresqlversionnotsupported'] =
        'Η τρέχουσα έκδοση της PostgreSQL δεν υποστηρίζεται από το phpPgAdmin. Παρακαλώ αναβαθμίστε στην έκδοση %s ή νεότερη.';
