...
// Welcome
$lang['strintro']         = 'Benvingut a phpPgAdmin6.';
$lang['strppahome']       = 'Pàgina web de phpPgAdmin6';
...
$lang['strconfdropcred']    =
    'Per raons de seguretat, la desconnexió eliminarà la informació d\'entrada compartida. Està segur de voler desconnectar ?';
...
// Error handling
$lang['strnoframes'] =
    'Aquesta aplicació treballa millor en un navegador amb suport per frames, però es pot usar sense seguint el link de sota.';
$lang['strnoframeslink'] = 'Usa sense frames';
$lang['strbadconfig']    =
    'El seu config.inc.php no està actualitzat. Necessitarà regenerar-lo a partir del nou config.inc.php-dist.';
$lang['strnotloaded'] =
    'La seva instal·lació de PHP no suporta la PostgreSQL. Necessita recompilar el PHP usant la opció de configuració --with-pgsql.';
...
$lang['strinvalidserverparam']            =
    'Intent de connexió amb un paràmetre del servidor invàlid, possiblement algú està provant d\'entrar al sistema.';
$lang['strnoserversupplied'] = 'No s\'ha proporcionat cap servidor!';
$lang['strbadpgdumppath']    =
    'Error d\'exportació: Fallada en l\'execució de pg_dump (path definit a conf/config.inc.php : %s ). Sisplau, arregli el path en la configuració.';
$lang['strbadpgdumpallpath'] =
    'Error d\'exportació: Fallada en l\'execució de pg_dumpall (path definit a conf/config.inc.php : %s ). Sisplau, arregli el path en la configuració.';
...
$lang['strftscantparsercopy']       =
    'No es pot especificar alhora un analitzador i una plantilla durant la creació de la configuració de la cerca de text.';
