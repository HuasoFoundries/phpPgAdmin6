...
// Bienvenido
$lang['strintro']         = 'Bienvenido a phpPgAdmin6.';
$lang['strppahome']       = 'Página web de phpPgAdmin6';
...
$lang['strconfdropcred']    =
    'Por razones de seguridad, al desconectar se destruirá tu información compartida. ¿Estás seguro que desea desconectarse?';
...
// Error handling
$lang['strnoframes'] =
    'Esta aplicación funciona mejor con un navegador con soporte para marcos, pero puede usarse sin marcos siguiendo el link de abajo.';
$lang['strnoframeslink'] = 'Usar sin marcos';
$lang['strbadconfig']    =
    'Su archivo config.inc.php está desactualizado. Deberá regenerarlo a partir del nuevo archivo config.inc.php-dist.';
$lang['strnotloaded'] =
    'Su instalación de PHP no tiene el soporte correcto para PostgreSQL. Deberá recompilar PHP usando la opción --with-pgsql en el configure.';
...
$lang['strinvalidserverparam']            =
    'Intento de conexión al servidor con un parámetro inválido. Posiblemente alguien está intentando atacar tu sistema.';
$lang['strnoserversupplied'] = 'No se suministró un servidor';
$lang['strbadpgdumppath']    =
    'Error de exportación: Falló la ejecución de execute pg_dump (según la ruta dada en conf/config.inc.php : %s). Por favor, arregla esta ruta en tu configuración y vuelve a iniciar sesión.';
$lang['strbadpgdumpallpath'] =
    'Error de exportación: Falló la ejecución de pg_dumpall (según la ruta dada en conf/config.inc.php : %s). Por favor, arregla esta ruta en tu configuración y vuelve a iniciar sesión.';
...
$lang['strftscantparsercopy']       =
    'No se puede especificar tanto el analizador como la plantilla durante la creación de la configuración de la búsqueda de texto.';

//Plugins
$lang['strpluginnotfound'] =
    'Error: el plugin \'%s\' no se encontró found. Chequea si existe en la carpeta plugins/ , o si el plugin contiene un archivo llamado plugin.php. Los nombres de los plugin son sensibles a las mayúsculas';
