...
$lang['strconfdropcred'] =
    'Dėl saugumo, ryšio nutraukimas panaikins jūsų bendrą prisijungimo informaciją. Ar tikrai norite nutraukti ryšį ?';
...
// Error handling
$lang['strnoframes'] =
    'Ši programa geriausiai veikia su naršykle, kurioje palaikomi HTML rėmeliai(frames),tačiau gali būti naudojama be rėmelių spustelėjus toliau pateiktą nuorodą.';
...
$lang['strnotloaded'] =
    'Jūsų PHP įdiegimas nepalaiko PostgreSQL. Reikia perkompiliuoti PHP naudojant --with-pgsql konfigūravimo parametrą.';
...
$lang['strcannotdumponwindows'] =
    'Atminties išklotinės suformavimas su sudėtingais lentelių ir schemų vardais Windows operacinėje sistemoje nepalaikomas';
$lang['strinvalidserverparam'] =
    'Bandymas prisijungti su negaliojančiu serverio parametru, galbūt kas nors bando nulaužti jūsų sistemą.';
$lang['strnoserversupplied'] = 'Nenurodytas serveris!';
$lang['strbadpgdumppath'] =
    'Eksportavimo klaida: nepavyko įvykdyti pg_dump (pateiktas kelias Jūsų conf/config.inc.php : %s). Pataisykite šį kelią savo konfigūracijoje ir prisijunkite iš naujo.';
$lang['strbadpgdumpallpath'] =
    'Eksportavimo klaida: nepavyko įvykdyti pg_dumpall (pateiktas kelias Jūsų conf/config.inc.php : %s). Pataisykite šį kelią savo konfigūracijoje ir prisijunkite iš naujo.';
