...
$lang['strviewfaq_url']   = 'http://phpPgAdmin6.sourceforge.net/doku.php?id=faq';
...
$lang['strconfdropcred']    =
    'Por motivos de seguridade, ao desconectarse destruirase a información compartida sobre a súa identidade. Está seguro de que quere desconectarse?';
...
// Error handling
$lang['strnoframes'] =
    'Este aplicativo funciona mellor nos navegadores que permiten o uso de marcos, pero pode usalo sen eles premendo na ligazón que hai máis abaixo.';
$lang['strnoframeslink'] = 'Utilizar sen marcos';
$lang['strbadconfig']    =
    'O seu ficheiro de configuración «config.inc.php» está obsoleto. Terá que volvelo crear a partires do novo ficheiro «config.inc.php-dist».';
$lang['strnotloaded'] =
    'A súa instalación de PHP non está preparada para utilizar PostgreSQL. Terá que compilar PHP de novo utilizando a opción de configuración «--with-pgsql».';
$lang['strpostgresqlversionnotsupported'] =
    'Este aplicativo non é compatible coa versión de PostgreSQL que está a usar. Actualíceo á versión %s ou outra versión posterior.';
...
$lang['strimporterror-fileformat'] =
    'Produciuse un erro ao importar: non se puido determinar de maneira automática o formato do ficheiro.';
...
$lang['strcannotdumponwindows']          =
    'O envorcado de táboas complexas e mais nomes de esquemas non pode efectuarse en sistemas Microsoft Windows.';
$lang['strinvalidserverparam'] =
    'Produciuse un intento de conexión cun servidor non permitido como parámetro, é posible que alguén estea intentando atacar o seu sistema.';
$lang['strnoserversupplied'] = 'Non se forneceu ningún servidor!';
$lang['strbadpgdumppath']    =
    'Produciuse un erro ao exportar: non se conseguiu executar pg_dump (a ruta indicada no seu ficheiro «conf/config.inc.php» é «%s»). Cambie a ruta no ficheiro de configuración e volva intentalo.';
$lang['strbadpgdumpallpath'] =
    'Produciuse un erro ao exportar: non se conseguiu executar pg_dumpall (a ruta indicada no seu ficheiro «conf/config.inc.php» é «%s»). Cambie a ruta no ficheiro de configuración e volva intentalo.';
...
$lang['strftscantparsercopy']       =
    'Non se pode especificar tanto un analizador coma un modelo durante a creación dunha configuración de busca de texto.';
