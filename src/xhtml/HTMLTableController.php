<?php
    ...
    class HTMLTableController extends HTMLController
    {
         ...
         *                                        is the entrypoint (/src/views/display.php) and 'browse' is the action used inside its controller
         *                                        (in
         *                                        this case, doBrowse).
         ...
         *                                        It can return an array of actions specific to the row,  or if nothing is returned then the standard
         *                                        actions are used.
         *                                        (see TablePropertyController and ConstraintController for examples)
         *                                        The function must not must not store urls because     they are relative and won't work out of
         *                                        context.
         * @return string
         */
