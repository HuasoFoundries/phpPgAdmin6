...
function doDefault($msg = '') {
	...
	$columns = [
		...
		'returns' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('proreturns'),
		],
		'owner' => [
			'title' => $lang['strowner'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('proowner'),
		],
		'proglanguage' => [
			'title' => $lang['strproglanguage'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('prolanguage'),
		],
		'actions' => [
		...
		'comment' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('procomment'),
		],
	];
		...
		'alter' => [
			...
			'attr' => [
				'href' => [
					...
					'urlvars' => [
						'action' => 'edit',
						'function' => \PHPPgAdmin\Decorators\Decorator::field('proproto'),
