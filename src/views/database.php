...
function doVariables() {
	...
	$columns = [
		'variable' => [
			'title' => $lang['strname'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('name'),
		],
		'value' => [
			'title' => $lang['strsetting'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('setting'),
		],
	];
...
function currentProcesses($isAjax = false) {
	...
	if ($data->hasPreparedXacts()) {
		...
		$columns = [
			'transaction' => [
				...
				'field' => \PHPPgAdmin\Decorators\Decorator::field('transaction'),
			],
			'gid' => [
				'title' => $lang['strgid'],
				'field' => \PHPPgAdmin\Decorators\Decorator::field('gid'),
			],
			'prepared' => [
				'title' => $lang['strstarttime'],
				'field' => \PHPPgAdmin\Decorators\Decorator::field('prepared'),
			],
			'owner' => [
				'title' => $lang['strowner'],
				'field' => \PHPPgAdmin\Decorators\Decorator::field('owner'),
			],
		];
	...
	$columns = [
		'user' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('usename'),
		],
		'process' => [
			'title' => $lang['strprocess'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('pid'),
		],
		'blocked' => [
			'title' => $lang['strblocked'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('waiting'),
		],
		'query' => [
			'title' => $lang['strsql'],
		...
		'start_time' => [
			'title' => $lang['strstarttime'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('query_start'),
		],
	];
				...
				'attr' => [
					'href' => [
						...
						'urlvars' => [
							'action' => 'signal',
							'signal' => 'CANCEL',
							'pid' => \PHPPgAdmin\Decorators\Decorator::field('pid'),
						],
					],
				],
			],
...
function currentLocks($isAjax = false) {
	...
	$columns = [
		...
		'tablename' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('tablename'),
		],
		'vxid' => [
			'title' => $lang['strvirtualtransaction'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('virtualtransaction'),
		],
		'transactionid' => [
		...
		'mode' => [
			'title' => $lang['strmode'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('mode'),
		],
		'granted' => [
			'title' => $lang['strislockheld'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('granted'),
			'type' => 'yesno',
		],
	];
