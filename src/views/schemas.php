...
function doDefault($msg = '') {
	...
	$columns = [
		...
		'owner' => [
			'title' => $lang['strowner'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('nspowner'),
		],
		'actions' => [
		...
		'comment' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('nspcomment'),
		],
	];
		...
		'drop' => [
			...
			'attr' => [
				'href' => [
					...
					'urlvars' => [
						'action' => 'drop',
						'nsp' => \PHPPgAdmin\Decorators\Decorator::field('nspname'),
					],
				],
			],
			'multiaction' => 'drop',
