		...
		if ($data->hasDomainConstraints()) {
			...
			$columns = [
				...
				'definition' => [
					...
					'field' => \PHPPgAdmin\Decorators\Decorator::field('consrc'),
				],
				'actions' => [
					...
					'attr' => [
						'href' => [
							...
							'urlvars' => [
								...
								'constraint' => \PHPPgAdmin\Decorators\Decorator::field('conname'),
								'type' => \PHPPgAdmin\Decorators\Decorator::field('contype'),
							],
						],
					],
				],
...
function doDefault($msg = '') {
	...
	$columns = [
		'domain' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('domname'),
			'url' => "domains.php?action=properties&amp;{$misc->href}&amp;",
			'vars' => ['domain' => 'domname'],
		],
		'type' => [
			'title' => $lang['strtype'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('domtype'),
		],
		'notnull' => [
			'title' => $lang['strnotnull'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('domnotnull'),
			'type' => 'bool',
			'params' => ['true' => 'NOT NULL', 'false' => ''],
		],
		'default' => [
			'title' => $lang['strdefault'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('domdef'),
		],
		'owner' => [
			'title' => $lang['strowner'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('domowner'),
		],
		'actions' => [
			'title' => $lang['stractions'],
		],
		'comment' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('domcomment'),
		],
	];
