...
function doDefault($msg = '') {
	...
	$columns = [
		'operator' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('oprname'),
			'url' => "operators.php?action=properties&amp;{$misc->href}&amp;",
			'vars' => ['operator' => 'oprname', 'operator_oid' => 'oid'],
		],
		'leftarg' => [
			'title' => $lang['strleftarg'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('oprleftname'),
		],
		'rightarg' => [
			'title' => $lang['strrightarg'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('oprrightname'),
		],
		'returns' => [
			'title' => $lang['strreturns'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('resultname'),
		],
		'actions' => [
		...
		'comment' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('oprcomment'),
		],
	];
		...
		'drop' => [
			...
			'attr' => [
				'href' => [
					...
					'urlvars' => [
						'action' => 'confirm_drop',
						'operator' => \PHPPgAdmin\Decorators\Decorator::field('oprname'),
