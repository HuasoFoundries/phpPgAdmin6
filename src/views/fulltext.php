...
function doDefault($msg = '') {
	...
	$columns = [
		...
		'schema' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('schema'),
		],
		'actions' => [
		...
		'comment' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('comment'),
		],
	];
		...
		'drop' => [
			...
			'attr' => [
				'href' => [
					...
					'urlvars' => [
						'action' => 'dropconfig',
						'ftscfg' => \PHPPgAdmin\Decorators\Decorator::field('name'),
					],
				],
			],
		],
		...
		'drop' => [
			...
			'attr' => [
				'href' => [
					...
					'urlvars' => [
						'action' => 'dropdict',
						'ftsdict' => \PHPPgAdmin\Decorators\Decorator::field('name'),
					],
				],
			],
		],
...
function doViewConfig($ftscfg, $msg = '') {
	...
	$columns = [
		...
		'dictionaries' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('dictionaries'),
		],
		'actions' => [
			'title' => $lang['stractions'],
		],
		'comment' => [
			'title' => $lang['strcomment'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('description'),
		],
	];
		...
		'drop' => [
			...
			'attr' => [
				'href' => [
					...
					'urlvars' => [
						'action' => 'dropmapping',
						'mapping' => \PHPPgAdmin\Decorators\Decorator::field('name'),
						'ftscfg' => \PHPPgAdmin\Decorators\Decorator::field('cfgname'),
					],
				],
			],
		],
...
function doTree() {
	...
	$attrs = [
		...
		'branch' => url('fulltext.php',
			...
			[
				'action' => 'subtree',
				'what' => \PHPPgAdmin\Decorators\Decorator::field('icon'), // IZ: yeah, it's ugly, but I do not want to change navigation tabs arrays
			]
		),
	];
...
function doSubTree($what) {
	...
	switch ($what) {
		case 'FtsCfg':
			...
			$urlvars = ['action' => 'viewconfig', 'ftscfg' => \PHPPgAdmin\Decorators\Decorator::field('name')];
			break;
		case 'FtsDict':
	...
	$attrs = [
		'text' => \PHPPgAdmin\Decorators\Decorator::field('name'),
		'icon' => $what,
