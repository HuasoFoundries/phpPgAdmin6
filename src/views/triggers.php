...
function doDefault($msg = '') {
	...
	$columns = [
		'trigger' => [
			'title' => $lang['strname'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('tgname'),
		],
		'definition' => [
			'title' => $lang['strdefinition'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('tgdef'),
		],
		'function' => [
			...
			'attr' => [
				'href' => [
					...
					'urlvars' => [
						...
						'trigger' => \PHPPgAdmin\Decorators\Decorator::field('tgname'),
					],
				],
			],
		],
