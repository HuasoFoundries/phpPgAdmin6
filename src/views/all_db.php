...
function doDefault($msg = '') {
	...
	$columns = [
		...
		'owner' => [
			'title' => $lang['strowner'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('datowner'),
		],
		'encoding' => [
			'title' => $lang['strencoding'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('datencoding'),
		],
		'lc_collate' => [
			'title' => $lang['strcollation'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('datcollate'),
		],
		'lc_ctype' => [
			'title' => $lang['strctype'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('datctype'),
		],
		'tablespace' => [
		...
		'dbsize' => [
			'title' => $lang['strsize'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('dbsize'),
			'type' => 'prettysize',
		],
		'actions' => [
		...
		'comment' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('datcomment'),
		],
	];
			...
			'attr' => [
				'href' => [
					...
					'urlvars' => [
						'subject' => 'database',
						'action' => 'confirm_drop',
						'dropdatabase' => \PHPPgAdmin\Decorators\Decorator::field('datname'),
					],
				],
			],
			...
			'attr' => [
				'href' => [
					...
					'urlvars' => [
						...
						'alterdatabase' => \PHPPgAdmin\Decorators\Decorator::field('datname'),
					],
				],
			],
		];
