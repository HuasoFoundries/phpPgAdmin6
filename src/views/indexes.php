...
function doDefault($msg = '') {
	...
	$columns = [
		'index' => [
			'title' => $lang['strname'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('indname'),
		],
		'definition' => [
			'title' => $lang['strdefinition'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('inddef'),
		],
		'constraints' => [
			'title' => $lang['strconstraints'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('+constraints'),
			'type' => 'verbatim',
			'params' => ['align' => 'center'],
		],
		'clustered' => [
			'title' => $lang['strclustered'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('indisclustered'),
			'type' => 'yesno',
		],
		'actions' => [
		...
		'comment' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('idxcomment'),
		],
	];
			...
			'attr' => [
				'href' => [
					...
					'urlvars' => [
						...
						'index' => \PHPPgAdmin\Decorators\Decorator::field('indname'),
					],
				],
			],
		],
