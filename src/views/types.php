		...
		switch ($typedata->fields['typtype']) {
			case 'c':
				...
				$columns = [
					'field' => [
						'title' => $lang['strfield'],
						'field' => \PHPPgAdmin\Decorators\Decorator::field('attname'),
					],
					'type' => [
						'title' => $lang['strtype'],
						'field' => \PHPPgAdmin\Decorators\Decorator::field('+type'),
					],
					'comment' => [
...
function doDefault($msg = '') {
	...
	$columns = [
		'type' => [
			'title' => $lang['strtype'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('typname'),
			'url' => "types.php?action=properties&amp;{$misc->href}&amp;",
			'vars' => ['type' => 'basename'],
		],
		'owner' => [
			'title' => $lang['strowner'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('typowner'),
		],
		'flavour' => [
			'title' => $lang['strflavor'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('typtype'),
			'type' => 'verbatim',
			'params' => [
				'map' => [
					'b' => $lang['strbasetype'],
		...
		'comment' => [
			'title' => $lang['strcomment'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('typcomment'),
		],
	];
