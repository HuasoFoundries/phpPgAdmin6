...
function doDefault($msg = '') {
	...
	$columns = [
		'sequence' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('seqname'),
			'url' => "sequences.php?action=properties&amp;{$misc->href}&amp;",
			'vars' => ['sequence' => 'seqname'],
		],
		'owner' => [
			'title' => $lang['strowner'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('seqowner'),
		],
		'actions' => [
		...
		'comment' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('seqcomment'),
		],
	];
