...
function doDefault($msg = '') {
	...
	$columns = [
		...
		'superuser' => [
			'title' => $lang['strsuper'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('usesuper'),
			'type' => 'yesno',
		],
		'createdb' => [
		...
		'expires' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('useexpires'),
			'type' => 'callback',
			'params' => ['function' => 'renderUseExpires', 'null' => $lang['strnever']],
		],
		'defaults' => [
			'title' => $lang['strsessiondefaults'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('useconfig'),
		],
		'actions' => [
		...
		'alter' => [
			...
			'attr' => [
				'href' => [
					...
					'urlvars' => [
						'action' => 'edit',
						'username' => \PHPPgAdmin\Decorators\Decorator::field('usename'),
					],
				],
			],
		],
