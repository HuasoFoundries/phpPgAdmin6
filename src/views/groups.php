				...
				'attr' => [
					'href' => [
						...
						'urlvars' => [
							...
							'user' => \PHPPgAdmin\Decorators\Decorator::field('usename'),
						],
					],
				],
			],
...
function doDefault($msg = '') {
	...
	$columns = [
		'group' => [
			'title' => $lang['strgroup'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('groname'),
		...
		'drop' => [
			...
			'attr' => [
				'href' => [
					...
					'urlvars' => [
						'action' => 'confirm_drop',
						'group' => \PHPPgAdmin\Decorators\Decorator::field('groname'),
					],
				],
			],
		],
