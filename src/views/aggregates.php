...
function doDefault($msg = '') {
	...
	$columns = [
		...
		'aggrtype' => [
			'title' => $lang['strtype'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('proargtypes'),
		],
		'aggrtransfn' => [
			'title' => $lang['straggrsfunc'],
			'field' => \PHPPgAdmin\Decorators\Decorator::field('aggtransfn'),
		],
		'owner' => [
			'title' => $lang['strowner'],
		...
		'comment' => [
			...
			'field' => \PHPPgAdmin\Decorators\Decorator::field('aggrcomment'),
		],
	];
